...
window.VC_DATA.msme =
{
 ...
 "payment": {
  "terms": [
   ...
   {
    "name": "Documents against Payment (DP)",
    "risk": "Moderate",
 ...
 "samadhaan": {
  "headline": "If your buyer is abroad, the MSMED Act does not reach them. This section is two separate answers — do not mix them up.",
  "export": {
   "headline": "A foreign buyer who does not pay",
   "intro": "There is no Indian statutory deadline you can enforce against a company in another country, and MSME Samadhaan cannot help you. Recovery is contractual and commercial, which is why almost all of the work happens <i>before</i> you ship.",
   "points": [
    "<b>The protection is bought, not claimed.</b> An irrevocable letter of credit, an advance, or ECGC cover taken out before shipping is the actual remedy. Once the goods have left on open account against a buyer you did not credit-check, your options narrow sharply. See <a href=\"#paid\" style=\"color:var(--accent-text)\">section 04</a>.",
    "<b>Your contract decides where you can sue.</b> A written governing-law and jurisdiction or arbitration clause is what gives you somewhere to go. Without one you are generally litigating in the buyer's country, under their law, at their pace.",
    "<b>Arbitration travels better than a court judgment.</b> India and around 170 other countries are party to the New York Convention, so a foreign arbitral award is usually easier to enforce abroad than an Indian court decree.",
    "<b>If you insured, claim.</b> An ECGC policy is a claim on your insurer, not a lawsuit against the buyer — a materially faster route. Follow the policy's notification deadlines, which are strict.",
    "<b>Unpaid export bills are also a compliance matter.</b> Export proceeds must be realised within the period RBI prescribes, and outstanding bills are tracked against you in EDPMS. Tell your AD bank early — extensions and write-offs are handled through them, not ignored."
   ]
  },
  "domestic": {
   "headline": "An Indian buyer who does not pay",
   "intro": "This is where the MSMED Act applies. It is a genuinely strong protection, and it is worth knowing if you also sell into the Indian market — but it has nothing to do with your export orders.",
   "points": [
    "Under the MSMED Act a buyer <b>in India</b> must pay a registered micro or small enterprise within <b>45 days</b> where there is a written agreement, or <b>15 days</b> where there is not.",
    "Section 43B(h) of the Income Tax Act gives that deadline teeth: a buyer who pays late <b>cannot claim the expense as a deduction</b> for that year. Finance teams at large Indian companies now track MSME ageing closely for this reason.",
    "Overdue amounts carry compound interest at three times the RBI bank rate, payable by the buyer.",
    "Unpaid? File on the <b>MSME Samadhaan</b> portal — free, online, and heard by a Micro and Small Enterprise Facilitation Council rather than a court. You must be Udyam registered."
   ],
   "url": "https://samadhaan.msme.gov.in/"
  },
  "caveat": "MSME Samadhaan and the 45-day rule bind buyers in India. Filing against an overseas customer is not an available remedy, and no amount of Udyam registration changes that. For export orders the answer is credit insurance, a letter of credit, and a contract that names its own jurisdiction."
 },
 "sectors": {
  ...
  "rows": [
   {
    "hs": "57",
    "label": "Carpets & floor coverings",
    "why": "Hand-knotted carpets are almost entirely a small-unit and household industry, concentrated around Bhadohi and Mirzapur."
   },
   {
    "hs": "42",
    "label": "Leather goods & bags",
    "why": "Kanpur, Chennai and Kolkata clusters, dominated by small tanneries and workshops."
   },
   {
    "hs": "64",
    "label": "Footwear",
    "why": "Agra and Ambur: thousands of small units, plus a large-factory segment competing with Vietnam."
   },
   {
    "hs": "61",
    "label": "Apparel (knitted)",
    "why": "Tiruppur alone is a dense network of small knitwear units."
   },
   {
    "hs": "62",
    "label": "Apparel (woven)",
    "why": "The most MSME-heavy manufacturing export India has, spread across a dozen clusters."
   },
   {
    "hs": "63",
    "label": "Made-up textiles",
    "why": "Home textiles from Karur and Panipat — heavily small-unit."
   },
   {
    "hs": "71",
    "label": "Gems & jewellery",
    "why": "Surat diamond polishing and Jaipur gemstones: enormous employment in small workshops."
   },
   {
    "hs": "69",
    "label": "Ceramics & pottery",
    "why": "Khurja and Morbi clusters."
   },
   {
    "hs": "70",
    "label": "Glassware",
    "why": "Firozabad bangles and glass artware."
   },
   {
    "hs": "95",
    "label": "Toys & sports goods",
    "why": "Meerut and Jalandhar. India holds under 1% of the US market — the largest untapped gap on this site."
   },
   {
    "hs": "44",
    "label": "Wood & woodcraft",
    "why": "Saharanpur carving and furniture units."
   },
   {
    "hs": "33",
    "label": "Perfumes & essential oils",
    "why": "Kannauj attar distillers, mostly family-scale."
   }
  ]
 }
};
